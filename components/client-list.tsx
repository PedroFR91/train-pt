...
export function ClientList() {
  ...
  const handleAssignRoutine = (clientId) => {
    router.push(`/clients/${clientId}/assign-routine`)
  }

  const handleSendForm = (clientId) => {
                ...
                <TableRow key={client.id}>
                  ...
                  <TableCell>
                    <Badge variant={client.subscription?.status === "active" ? "default" : "secondary"}>
                      {client.subscription?.status === "active" ? "Activo" : "Inactivo"}
                    </Badge>
                  </TableCell>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={() => handleViewProfile(client.id)}>Ver perfil</DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleAssignRoutine(client.id)}>
                          Asignar rutina
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => handleSendForm(client.id)}>Enviar formulario</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </TableCell>
                </TableRow>
