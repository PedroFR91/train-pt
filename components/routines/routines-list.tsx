...
const dummyRoutines = [
  { id: 1, name: "Pérdida de peso", type: "Cardio", difficulty: "Intermedio", duration: "45 min" },
  { id: 2, name: "Tonificación", type: "Fuerza", difficulty: "Avanzado", duration: "60 min" },
  { id: 3, name: "Flexibilidad", type: "Yoga", difficulty: "Principiante", duration: "30 min" },
  // ... más rutinas
]
